...
def usage():
    print "./anarchist.py -t <target> [-r <threads> -p <port> -T -h]"
    ...
    print "Eg. ./anarchist.py -t 192.168.1.100 -r 256\n"
...
if __name__ == "__main__":
    ...
    print " * Anarchist Allies."
    print " * Living The Light, Serving The Light"
